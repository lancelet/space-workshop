...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \draw[ultra thick,grey] (0.932,0.448) arc [start angle=15,end angle=180,x radius=2cm,y radius=1.732cm];
...
Finally, Figure~\ref{fig:hohmann-ultra-low-impulse} shows an much lower-impulse scenario (only \SI{~75}{N} acting on a \SI{3000}{kg} spacecraft), resulting in an outcome which is clearly different from the analytical solution. This is expected, since the thrust is definitely not instantaneous, and large portions of the trajectory are produced under thrust conditions.

...
Figure~\ref{fig:ellipse-geometry} illustrates the geometry of an ellipse. The dimensions for its semi-minor axis, \gls{as}, and semi-major axis, \gls{bs}, are shown along with the radial distances of the periapsis (closest distance), \gls{rp}, and apoapsis (furthest distance), \gls{ra}.
